...
final class Init extends AbstractMigration
{
    public function change(): void
    {
      ...
      $table->addColumn('osoba_id', 'integer', ['comment' => 'Id osoby v prihlasce (pp_osoba.id)'])
        ...
        $table->addColumn('id', 'integer', ['null' => false])
              ->addColumn('doporuceni_spravce', 'text', ['null' => true])
              ->addColumn('doporuceni_spravce_oduvodneni', 'text', ['null' => true])
              ->addColumn('duvod_neplneni', 'text', ['null' => true])
              ->addColumn('plni_povinnosti', 'string', ['null' => true])
              ->addColumn('stanovisko_dluznika', 'text', ['null' => true])
              ->addColumn('vyjadreni_spravce', 'text', ['null' => true])
        ...
        $table->addColumn('zplo_id', 'integer', ['comment' => 'Zprava o plneni oddluzeni'])
              ...
              ->addColumn('celkem_prerozdeleno', 'decimal', ['null' => true, 'comment' => 'Kc doposud rozdeleno veritelum k tomuto mesici', 'scale' => DEC_SCAL, 'precision' => DEC_PREC])
              ->addColumn('mira_uspokojeni', 'decimal', ['null' => true, 'comment' => 'Aktualni mira uspokojeni k tomuto mesici', 'scale' => DEC_SCAL, 'precision' => DEC_PREC])
              ->addColumn('mira_uspkojeni_ocekavana', 'decimal', ['null' => true, 'comment' => 'Ocekavana mira uspokojeni k tomuto mesici', 'scale' => DEC_SCAL, 'precision' => DEC_PREC])
        ...
        $table->addColumn('id', 'integer', ['null' => false])
              ...
              ->addColumn('doporuceni_spravce', 'text', ['null' => true])
              ->addColumn('doporuceni_spravce_oduvodneni', 'text', ['null' => true])
              ->addColumn('zprava_o_prubehu', 'text', ['null' => true])

              ->addColumn('n_predpoklad_uspokojeni_mira', 'decimal', ['null' => true, 'scale' => DEC_SCAL, 'precision' => DEC_PREC])
              ->addColumn('n_predpoklad_uspokojeni_vyse', 'decimal', ['null' => true, 'scale' => DEC_SCAL, 'precision' => DEC_PREC])
              ->addColumn('n_uspokojeni_mira', 'decimal', ['null' => true, 'scale' => DEC_SCAL, 'precision' => DEC_PREC])
              ->addColumn('n_uspokojeni_vyse', 'decimal', ['null' => true, 'scale' => DEC_SCAL, 'precision' => DEC_PREC])
              ->addColumn('z_uspokojeni_mira', 'decimal', ['null' => true, 'scale' => DEC_SCAL, 'precision' => DEC_PREC])
              ->addColumn('z_uspokojeni_vyse', 'decimal', ['null' => true, 'scale' => DEC_SCAL, 'precision' => DEC_PREC])
              ->addColumn('preplatek', 'decimal', ['null' => true, 'scale' => DEC_SCAL, 'precision' => DEC_PREC])
              ->addForeignKey('id', 'dokument', 'id', ['delete'=> 'CASCADE', 'update'=> 'CASCADE'])
              ->create();
        ...
        $table->addColumn('zspo_id', 'integer', ['comment' => 'Zprava o splneni oddluzeni'])
            ->addColumn('celkova_odmena', 'decimal', ['null' => true, 'scale' => DEC_SCAL, 'precision' => DEC_PREC])
            ->addColumn('celkova_odmena_uhrazeno', 'decimal', ['null' => true, 'scale' => DEC_SCAL, 'precision' => DEC_PREC])
            ->addColumn('hotove_vydaje', 'decimal', ['null' => true, 'scale' => DEC_SCAL, 'precision' => DEC_PREC])
            ->addColumn('hotove_vydaje_uhrazeno', 'decimal', ['null' => true, 'scale' => DEC_SCAL, 'precision' => DEC_PREC])
            ->addColumn('vytezek_zpenezeni_rozdeleni', 'decimal', ['null' => true, 'scale' => DEC_SCAL, 'precision' => DEC_PREC])
            ->addColumn('vytezek_zpenezeni_rozdeleni_uhrazeno', 'decimal', ['null' => true, 'scale' => DEC_SCAL, 'precision' => DEC_PREC])
            ->addColumn('vytezek_zpenezeni_zaji', 'decimal', ['null' => true, 'scale' => DEC_SCAL, 'precision' => DEC_PREC])
            ->addColumn('vytezek_zpenezeni_zaji_uhrazeno', 'decimal', ['null' => true, 'scale' => DEC_SCAL, 'precision' => DEC_PREC])
            ->addColumn('zprava_spravce', 'text', ['null' => true])
