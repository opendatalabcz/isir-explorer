            ...
            <div class="max-w-6xl sm:px-6 lg:px-8">
                ...
                <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
                    <div class="text-center text-sm text-gray-500 sm:text-left">
                        Započteny pouze řízení zahájeny v roce 2019
                    </div>
...
<script type="text/javascript">
    ...
    L.tileLayer('https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token=pk.eyJ1IjoidHVtYXBhdjMiLCJhIjoiY2trZDV2M3JtMDZvOTJ3cXR2bDJ5MmdpayJ9.hQJeUhXdDbq-ktZZoNWpRQ', {
        maxZoom: 18,
